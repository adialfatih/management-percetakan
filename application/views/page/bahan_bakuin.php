            ...
            <div class="card-header" style="width:100%;display:flex;justify-content:space-between;">
              <div>
                  ...
                  <p class="text-sm mb-0">
                    Menampilkan Data Bahan Baku Masuk
                  </p>
              </div>
              <div style="display:flex;justify-content:flex-end;gap:10px;">
                  <a href="<?=base_url('input/bahan-baku');?>"><button class="btn btn-primary"><i class="material-symbols-rounded">note_add</i> &nbsp; Input Pembelian</button></a>
                  <a href="<?=base_url('nota/bahan-baku');?>"><button class="btn btn-info"><i class="material-symbols-rounded">payments</i> &nbsp; Nota Pembelian</button></a>
                  ...
                  if($inData->num_rows() >0){
                      foreach($inData->result() as $val){
                          ...
                          <tr>
                              ...
                              <td class="text-sm font-weight-normal"><?=$val->jenis_barang;?></td>
                              <td class="text-sm font-weight-normal"><?=$val->nama_barang;?></td>
                              <td class="text-sm font-weight-normal"><?=$_ukuran." ".$_satuan_ukuran;?></td>
                              <td class="text-sm font-weight-normal"><?=$val->jumlah_masuk." ".$val->satuan_jumlah;?></td>
                              <td class="text-sm font-weight-normal"><?=$val->supplier;?></td>
                          </tr>
                          <?php
                      }
                  }
