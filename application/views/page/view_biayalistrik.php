        ...
        <div class="col-12">
          ...
          <div class="card">
            ...
            <div class="card-header" style="width:100%;display:flex;justify-content:space-between;">
              <div>
                  <h5 class="mb-0">Biaya Listrik</h5>
                  <p class="text-sm mb-0">
                    Menampilkan Data Pembayaran Biaya Listrik Bulanan
                  </p>
              </div>
              <div style="display:flex;justify-content:flex-end;gap:10px;">
                  <button class="btn btn-primary" id="openModalButton"><i class="material-symbols-rounded">inventory</i> &nbsp; Pembayaran Listrik</button>
              </div>
            </div>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Input Biaya Listrik</h5>
          </div>
          <?php echo form_open_multipart('simpan-listrik',array('name' => 'spreadsheet')); ?>
