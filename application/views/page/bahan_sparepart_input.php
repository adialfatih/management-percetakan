        ...
        <div class="col-12">
          ...
          <div class="card">
            ...
            <div class="card-header" style="width:100%;display:flex;justify-content:space-between;">
              <div>
                  <h5 class="mb-0">Pembelian Sparepart</h5>
            ...
            <div class="table-responsive" style="padding:0 15px;margin:10px 0 20px 0;">
                ...
                <div style="width:100%;border-bottom:2px solid #ccc;padding-bottom:5px;margin-bottom:20px;">
                    <span style="color:#2e2e2e;">Data Sparepart Masuk</span>
                </div>
                <div class="form-dta">
                    ...
                    <datalist id="jenisbarangListBantu">
                        <?php foreach($jenisSparepart->result() as $sp){ ?>
                        <option value="<?=$sp->nama_barang;?>">
                        <?php } ?>
                    </datalist>
                </div>
                <div class="form-dta">
                    <label for="namaBarangBantu">Nama Barang</label>
                    <input type="text" list="namabarangListBantu" style="max-width:100%;width:400px;" placeholder="Masukan / Pilih Barang" class="form-control2" name="namabarangbantu" id="namaBarangBantu" onchange="teschange41()" onkeyup="teschange41()" required>
                ...
                <div class="form-dta">
                    ...
                    <button class="btn btn-success" id="addBahanSpare">Tambahkan Sparepart</button>
                </div>
            </div>
          </div>
        </div>
