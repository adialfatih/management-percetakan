            ...
            <div class="card-header" style="width:100%;display:flex;justify-content:space-between;">
                <div>
                    ...
                    <p class="text-sm mb-0">
                        Menampilkan Data Sparepare Masuk
                    </p>
                </div>
                <div style="display:flex;justify-content:flex-end;gap:10px;">
                  <a href="<?=base_url('input/sparepart');?>"><button class="btn btn-primary"><i class="material-symbols-rounded">note_add</i> &nbsp; Input Pembelian</button></a>
                  <a href="<?=base_url('nota/sparepart');?>"><button class="btn btn-info"><i class="material-symbols-rounded">payments</i> &nbsp; Nota Pembelian</button></a>
