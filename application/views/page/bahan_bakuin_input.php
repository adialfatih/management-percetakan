        ...
        <div class="col-12">
          <div class="card">
            ...
            <div class="card-header" style="width:100%;display:flex;justify-content:space-between;">
              <div>
                  <h5 class="mb-0">Pembelian Bahan Baku</h5>
            ...
            <div class="table-responsive" style="padding:0 15px;margin:10px 0 20px 0;">
                ...
                <div class="form-dta">
                    <label for="totalHarga3">Presentase Pajak</label>
                    <?php if($data_row=="null"){ ?>
                ...
                <div class="form-dta">
                    ...
                    <input type="text" list="namabarangList" style="max-width:100%;width:400px;" placeholder="Masukan / Pilih Barang" class="form-control2" name="namabarang" id="namaBarang" onchange="teschange3()" onkeyup="teschange3()" required>
                    <datalist id="namabarangList"></datalist>
                    <small id="load1"></small>
                </div>
                <div class="form-dta">
                    <label for="ukuranBarang">Ukuran</label>
                    <input type="text" list="ukuranbarangListBaku" style="max-width:100%;width:400px;" placeholder="Masukan Ukuran" class="form-control2" name="ukuranbarang" id="ukuranBarang" required>
                    <datalist id="ukuranbarangListBaku"></datalist>
