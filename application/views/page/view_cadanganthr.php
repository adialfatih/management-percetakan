        ...
        <div class="col-12">
          ...
          <div class="card">
            ...
            <div class="card-header" style="width:100%;display:flex;justify-content:space-between;">
              <div>
                  <h5 class="mb-0">Cadangan THR</h5>
                  <p class="text-sm mb-0">
                    Menampilkan Data Cadangan THR
                  </p>
              </div>
              <div style="display:flex;justify-content:flex-end;gap:10px;">
                  <button class="btn btn-primary" id="openModalButton"><i class="material-symbols-rounded">inventory</i> &nbsp; Cadangan THR</button>
              </div>
            </div>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Input Cadangan THR</h5>
          </div>
          <?php echo form_open_multipart('simpan-thr',array('name' => 'spreadsheet')); ?>
          <div class="modal-body">
                ...
                <br>
                <div>
                    <label class="form-label">Cadangan THR</label>
