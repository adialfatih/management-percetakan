        ...
        <div class="col-12">
          ...
          <div class="card">
            ...
            <div class="card-header" style="width:100%;display:flex;justify-content:space-between;">
              <div>
                  <h5 class="mb-0">Biaya Penyusutan</h5>
                  <p class="text-sm mb-0">
                    Menampilkan Data Biaya Penyusutan
                  </p>
              </div>
              <div style="display:flex;justify-content:flex-end;gap:10px;">
                  <button class="btn btn-primary" id="openModalButton"><i class="material-symbols-rounded">inventory</i> &nbsp; Input Penyusutan</button>
              </div>
            </div>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Input Biaya Penyusutan</h5>
          </div>
          <?php echo form_open_multipart('simpan-susut',array('name' => 'spreadsheet')); ?>
          <div class="modal-body">
                <div>
                    <label class="form-label">Bulan</label>
                    <input type="month" class="form-control2" name="bulanlis" id="tanggalProduksi2" required>
                </div>
                <br>
                <div>
                    <label class="form-label">Biaya Susut</label>
                    <input type="text" oninput="formatNumber(this)" class="form-control2" name="nominal" id="nominal" required>
                </div>
